...
<html lang="en">
  ...
  <body>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <br>
            <form method="POST" action="controller/storeEquipoTareasc.php" enctype="multipart/form-data">
              <hr>
    ...
    <script src="js/buscarEquipos2c.js"></script>
  </body>
</html>